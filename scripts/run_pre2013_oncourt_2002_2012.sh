...
for y in 2002 2003 2004 2005 2006 2007 2008 2009 2010 2011 2012; do
  out="public/data/pre2013/player_oncourt_game_all/${y}.json"

  if [ -s "$out" ] && [ "$(wc -c < "$out")" -gt 1000 ]; then
    echo "Skipping $y because output exists: $out"
    continue
  fi
...
echo "ALL 2002-2012 PRE-2013 YEARS FINISHED"
